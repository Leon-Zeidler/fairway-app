...
export const PROGRAMS: Program[] = [
  {
    id: "range-path",
    title: "Range · Swing Path",
    group: "golf",
    groupLabel: "Range & Golf",
    focus: "Von innen schwingen – Gate- & Headcover-Drills (Mo)",
    activityKey: "technik",
    sessionType: "range",
    current: true,
    sections: [{ steps: routine("golf2").steps }],
  },
  {
    id: "range-driver",
    title: "Range · Driver & Topping",
    group: "golf",
    groupLabel: "Range & Golf",
    focus: "Sauberer, selbstbewusster Treffer – Haltung halten (Mi)",
    activityKey: "technik",
    sessionType: "range",
    sections: [{ steps: routine("golf3").steps }],
  },
  {
    id: "range-basics",
    title: "Range · Basics (Reverse Pivot)",
    group: "golf",
    groupLabel: "Range & Golf",
    focus: "Basis-Drills: Kopf hoch, Schulter unter Kinn, Gewicht rechts (Fr)",
    activityKey: "technik",
    sessionType: "range",
    sections: [{ steps: DRILLS }],
  },
  {
    id: "kurzspiel",
  ...
  },
  {
    ...
    focus: "Volle Kraft-Session, 2×/Woche – Kreuzheben, Klimmzüge, Drücken (angelehnt an Rory McIlroy)",
    activityKey: "gym",
    sessionType: "gym",
    sections: [
      { title: "Warmup · Mobility & Activation", steps: WARMUP_RORY },
      { title: "Hauptblock", steps: RORY_STRENGTH },
    ],
  },
  {
    id: "rory-power",
  ...
  },
  {
    ...
    group: "gym",
    groupLabel: "Rory · Fitness",
    focus: "Ausdauer + Core – Schwimmen/Intervalle, Carry, Anti-Rotation (angelehnt an Rory McIlroy)",
    activityKey: "gym",
    sessionType: "gym",
    sections: [
      { title: "Warmup · Mobility & Activation", steps: WARMUP_RORY },
