...
Deine Aufgaben:
1. Aktualisierte Carry-Distanzen vorschlagen → Array "clubProposals". Für jeden Schläger mit genug Daten (shots >= 3, oder shots = 0 ⇒ Wert stammt aus einem Report/Bild und ist trotzdem gültig) und spürbarem Unterschied zur aktuellen Bag-Distanz EIN Eintrag. Mappe den Trackman-Namen auf den passenden Bag-Schläger aus context.clubs ("7 Iron"→"7 Eisen", "Pitching Wedge"→"PW", "Sand Wedge"→passender Wedge). Nutze die GELIEFERTEN carryAvg-Werte (NICHT selbst rechnen). Kein passender Bag-Schläger → weglassen.
   Format: [{"name":"7 Eisen","newDistance":"148 m","carryAvg":148,"shots":12,"reason":"kurz, warum"}]
   Verwende für Distanz-Änderungen im Trackman-Kontext AUSSCHLIESSLICH "clubProposals" — kein set_club.
